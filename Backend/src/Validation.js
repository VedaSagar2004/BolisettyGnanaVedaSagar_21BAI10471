export class Validation {
    ...
    hero1(move, i, j, player, board){
        if (player == 1){
            if (move == "F"){
                if (i-2 >= 0){
                    if ((board[i-2][j] && board[i-2][j][2] == 'b')||(board[i-1][j] && board[i-1][j][2] == 'b')){
                        return false
                    }
                    else {
                        return true
            ...
            if (move == "L"){
                if (j-2 >= 0){
                    if ((board[i][j-2] && board[i][j-2][2] == 'b')||(board[i][j-1] && board[i][j-1][2] == 'b')){
                        return false
                    }
                    else {
                        return true
    ...
    hero2(move, i, j, player, board){
        if (player == 1){
            if (move == "FR"){
                if (i-2 >= 0 && j+2 <= 4){
                    if ((board[i-2][j+2] && board[i-2][j+2][2] == 'b')||(board[i-1][j+1] && board[i-1][j+1][2] == 'b')){
                        return false
                    }
                    else{
                        return true
